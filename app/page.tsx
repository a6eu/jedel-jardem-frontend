                    ...
                    <div className="flex flex-1 items-center justify-end space-x-4">
                        <nav className="flex items-center space-x-2">
                            ...
                            <Link href="/auth/register" passHref>
                                <Button
                                    className="bg-gradient-to-r from-pink-500 to-violet-500 text-white">Register</Button>
                            </Link>
                        </nav>
                    </div>
                </div>
                    ...
                    <div className="container px-4 md:px-6">
                        <div className="flex flex-col items-center justify-center space-y-4 text-center">
                            <div className="space-y-2">
                                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none bg-gradient-to-r from-pink-500 to-violet-500 bg-clip-text text-transparent">
                            ...
                            <div className="flex flex-col gap-2 min-[400px]:flex-row">
                                <Link href="/auth/register" passHref>
                                    <Button className="bg-gradient-to-r from-pink-500 to-violet-500 text-white">Get
                                        Started</Button>
                                </Link>
                                <Link href="/auth/login" passHref>
                    ...
                    <div className="container px-4 md:px-6">
                        <div className="grid gap-6 lg:grid-cols-3 lg:gap-12">
                            <div className="flex flex-col justify-center space-y-4">
                                <div className="inline-block rounded-lg bg-pink-100 p-3 text-pink-500">
                                    <svg
                            ...
                            <div className="flex flex-col justify-center space-y-4">
                                <div className="inline-block rounded-lg bg-violet-100 p-3 text-violet-500">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="24"
                                        height="24"

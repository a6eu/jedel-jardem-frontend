            ...
            <div className="container px-4 md:px-6">
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  <h1
                    className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none bg-gradient-to-r from-teal-500 to-teal-700 bg-clip-text text-transparent">
          ...
          <section className="w-full py-12 md:py-24 lg:py-32 bg-white">
            <div className="container px-4 md:px-6">
              ...
              <div className="grid gap-6 lg:grid-cols-3 lg:gap-12 mt-12">
                ...
                <div
                  className="flex flex-col p-6 bg-gradient-to-b from-teal-100 to-white rounded-lg border border-teal-200 shadow-md relative">
                  <div
                    className="absolute top-0 right-0 bg-teal-600 text-white text-xs font-bold px-2 py-1 rounded-bl-lg rounded-tr-lg">
                    POPULAR
                  </div>
